...
Marowak_AAnimationIdle:  INCLUDE "gfx/pokemon/marowak_a/anim_idle.asm"
Wooper_PAnimationIdle:   INCLUDE "gfx/pokemon/wooper_p/anim_idle.asm"
...
OreonAnimationIdle:      INCLUDE "gfx/pokemon/oreon/anim_idle.asm"
