...
Marowak_APokedexEntry::  INCLUDE "data/pokemon/dex_entries/marowak_a.asm"
Wooper_PPokedexEntry::   INCLUDE "data/pokemon/dex_entries/wooper_p.asm"
...
OreonPokedexEntry::      INCLUDE "data/pokemon/dex_entries/oreon.asm"
